...
def main():
    ...
    try:
        ...
        if command == '1':
            ...
            folders = ['Mary', 'Sue']
            TrainModel('employees_group', 'employees', folders)
        elif command =='4':
            RecognizeFaces(os.path.join('images','people2.jpg'), 'employees_group')
        elif command == '5':
            VerifyFace(os.path.join('images','person1.jpg'), 'Mary', 'employees_group')
...
def VerifyFace(person_image, person_name, group_id):
    ...
    # if we have a face and an ID, do they match?
    if face_id_found and face_found:
